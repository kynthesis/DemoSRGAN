...
class StarRRDB(nn.Module):
    ...
    def __init__(self, num_feat, num_grow_ch=32):
        ...
        self.star_rdb1 = StarResidualDenseBlock(num_feat, num_grow_ch)
        self.star_rdb2 = StarResidualDenseBlock(num_feat, num_grow_ch)
        self.star_rdb3 = StarResidualDenseBlock(num_feat, num_grow_ch)
