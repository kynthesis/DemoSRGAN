...
class StarSRModel(SRModel):
    """StarSR model for single image super-resolution."""
    ...
    def init_training_settings(self):
        ...
        self.net_p = build_network(self.opt['network_p'])
        ...
        if load_path_p is not None:
            param_key = self.opt['path'].get('param_key_g', 'params')
            self.load_network(self.net_p, load_path_p, self.opt['path'].get('strict_load_g', True), param_key)
