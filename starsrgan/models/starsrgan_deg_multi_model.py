...
class StarSRGANDegMultiModel(SRGANModel):

    def __init__(self, opt):
        super(StarSRGANDegMultiModel, self).__init__(opt)
    ...
    def feed_data(self, data_all):
        if self.is_train:
            ...
            if self.degradation_degree == 'severe_degrade_two_stage':
                ...
                self.gt, self.lq, self.top, self.left = paired_random_crop_return_indexes(
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(StarSRGANDegMultiModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
